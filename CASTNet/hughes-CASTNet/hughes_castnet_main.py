...
train_static, train_sample_indices, train_dist, train_y, valid_static, valid_sample_indices, valid_dist, valid_y, test_static, test_sample_indices, test_dist, test_y = hughes_data.readData(conf.dataset_name, conf.window_size, conf.lead_time, conf.train_ratio, conf.test_ratio, conf.dist, conf.time_unit)
...
print ('train_static:', train_static.shape, 'train_dist:', train_dist.shape, 'train_y:', train_y.shape)
print ('valid_static:', valid_static.shape, 'valid_dist:', valid_dist.shape, 'valid_y:', valid_y.shape)
print ('test_static:', test_static.shape, 'test_dist:', test_dist.shape, 'test_y:', test_y.shape)


HOW TO REPLACE?
#temporal_feature_size = train_crime_global.shape[-1]
no_locations = train_dist.shape[1]
...
castnet.train(train_static, train_sample_indices, train_dist, train_y, valid_static, valid_sample_indices, valid_dist, valid_y, test_static, test_sample_indices, test_dist, test_y)
